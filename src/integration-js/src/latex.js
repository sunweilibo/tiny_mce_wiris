...
export default class Latex {
  ...
  */
  ...
  static getMathMLFromLatex(latex, includeLatexOnSemantics) {
    ...
    let jsonResponse;
    try {
      jsonResponse = JSON.parse(ServiceProvider.getService('service', data));
    } catch (error) {
      jsonResponse = { status: 'ok', result: { text: '<math xmlns="http://www.w3.org/1998/Math/MathML"><mtext mathvariant="bold" mathcolor="#FF0000">[fail!]</mtext></math>' } };
    }
