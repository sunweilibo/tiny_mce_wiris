...
export default class Image {
  ...
  */
  static setImgSize(img, uri, jsonResponse) {
    ...
    img.width = width;
    img.height = height;
    img.style.verticalAlign = `${baseline}px`;
  }
  ...
  static getMetricsFromSvgString(svgString) {
    const html = new DOMParser().parseFromString(svgString, 'image/svg+xml');
    const width = html.firstChild.getAttribute('width');
    const height = html.firstChild.getAttribute('height');
    const baseline = html.firstChild.style.verticalAlign;
